...
insert into user (dtype, id, firstname, lastname, username, password, blocked, address, email, operates_since, store_name) values ('Admin', 3, 'Tiba', 'Tibic' , 'tiba', '444', false, 'Valentina Vodnika 21', 'tibatibic@gmail.com', '1999-10-10', '')
...
insert into role_has_user (user_id, role_id) values (3, 3)
...
insert into article (id, description, name, path, price, seller_id) values (2, 'Lenovo Pro 13.3 inches Thinkpad MF841LL/A Model 2015 Option Ram Care 12/2016', 'Lenovo Thinkpad 13.3" MF841LL/A', 'http://media.bizwebmedia.net//sites/72783/data/images/2015/11/3220113retina13.jpg', 4300, 1)
