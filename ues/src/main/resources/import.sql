...
insert into errand (id, anonymous_comment, archived_comment, comment, grade, is_Delivered, ordered_at_date, buyer_id) values (3, false, true, 'Treci komentar koji je arhiviran', 7, true, '2022-01-01', 2)
